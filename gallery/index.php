...
$photosetInfo=$f->photosets_getList(null);
$photosetArray=$photosetInfo['photoset'];
?>
...
<html>
    ...
    <body>
		<h1>HelloWind Photobar Gallery</h1>
		<div id="pp_gallery" class="pp_gallery">
			...
			<?php
				foreach($photosetArray as $tvalue)
				{
					echo "<div class=\"album\">";
					$photosList=($f->photosets_getPhotos($tvalue['id'],null,null,500,1,null));
					
					$photosListArray=$photosList['photoset']['photo'];
					
					foreach ($photosListArray as $ttvalue )
					{
						echo "<div class=\"content\">";
						$photoUrl='http://farm'.$ttvalue['farm'].'.staticflickr.com/'.$ttvalue['server'].'/'.$ttvalue['id'].'_'.$ttvalue['secret'].'_';
						echo '<img id="'.$ttvalue['id'].'" src="'.$photoUrl.'s.jpg"'.' alt="'.$photoUrl.'b.jpg'.'"></img>';
						echo '<span>'.$ttvalue['title'].'</span>';
						echo "</div>";
					}
        ...
        <script type="text/javascript">
            ...
            $(function() {
				...
				function showImage(nav){
					...
					var imgL_id				= $thumb.prop('id');
					currentImageId			= imgL_id;
					...
					$('<img style=""/>').load(function(){
						...
						var $preview = $('<div />',{
							'id'		: 'pp_preview',
							'class'	: 'pp_preview',
							'html'     	: '<div class="pp_descr"><span><a href="photo.php?id='+currentImageId+'">'+imgL_description+'</a></span></div>',
